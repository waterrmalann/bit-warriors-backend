...
import { AuthUserViaGithub, AuthUserViaGoogle, LoginUser, LoginUserMFA, LogoutUser, RegisterUser, VerifyEmail } from '../controllers/AuthController.js';
...
router.post('/oauth-google', AuthUserViaGoogle);
